...
class Novel(nn.Module):
    def __init__(self,inplace):
        ...
        self.conv12 = convBlock(ly[0],ly[1])
        
        self.conv21 = convBlock(ly[1],ly[1])
        self.conv22 = convBlock(ly[1],ly[2])
        
        self.conv31 = convBlock(ly[2],ly[2])
        self.conv32 = convBlock(ly[2],ly[3])
        
        self.conv41 = convBlock(ly[3],ly[4])
        self.conv42 = convBlock(ly[4],ly[4])

        self.conv43=convBlock(ly[4],ly[5])
        self.conv44=convBlock(ly[5],ly[6])

        self.conv51=convBlock(ly[6],ly[6])
