...
class BrainAgeDataset(Dataset):
    def __init__(self, data_dir):
        ...
        self.agelist=[]
        #for i1 in ['UMass_T1']:
        for i1 in ['UMass_T1','HCP_T1','NACC_T1','ADNI_ML_images/ADNI1_CN','ADNI_ML_images/ADNI2_CN']:
            if i1=='NACC_T1':
                with open('/projectnb/bucbi/NACC_T1/input_list_NACC.txt') as file:
                    for line in file:
                        ...
                        input_file1= glob.glob(f"{input_f_name}/intensity_brain_occi.nii.gz")[0]
                        input_file2= glob.glob(f"{input_f_name}/ravens_brain_occi.nii.gz")[0]
                ...
                with open('/projectnb/bucbi/GW_session2/input_list_GW2.txt') as file:
                    for line in file:
                        ...
                        input_f_name = f"{data_dir}/{i1}/{input_folder}"
                        input_file1= glob.glob(f"{input_f_name}/intensity_brain_occi.nii.gz")[0]
                        input_file2= glob.glob(f"{input_f_name}/ravens_brain_occi.nii.g")[0]
                        self.data_list1.append(input_file1)
                        self.data_list2.append(input_file2)
                        for i in range(len(self.s1)):
                            #print("hi")
